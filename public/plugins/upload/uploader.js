            ...
            uploader.on('uploadSuccess', function (file, response) {
                if (response.Succenss) {
                    ...
                    if(response.path)
                    {
                        ...
                        $('.img-preview').html('<img id="avatar" src='+response.path+' />');
                        $.ajax({
                            url : '/users/setting/avatar',
                            type:'POSt',
                            beforeSend:function(){
                                $('.upload-btn').html('图片上传中。。');
                            },
                            data:{'id':$('#uid').val(),'avatar':$('#thumb').val()},
                            success:function(msg){
                                var msgObj= $.parseJSON(msg);
                                $('.upload-btn').html(msgObj.errorMsg);

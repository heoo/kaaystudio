...
class barcode{
		...
		public $code_string;
			function __construct($arr){
				...
				$this->size = $arr['size']? $arr["size"]:"20";
				$this->text = $arr['text']? $arr["text"]:"0" ;
				$this->orientation = $arr["orientation"] ? $arr["orientation"]:"horizontal";
				$this->code_type = $arr["code_type"] ? $arr["code_type"]:"code128";
				$this->code_string = "";
			}		
